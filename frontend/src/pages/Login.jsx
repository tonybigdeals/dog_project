    ...
    return (
        <div className="max-w-[430px] mx-auto min-h-screen flex flex-col bg-background-light dark:bg-background-dark text-[#1b120e] dark:text-[#fcf9f8] p-6">
            <header className="py-12 text-center">
                <div className="size-20 bg-primary/20 rounded-3xl flex items-center justify-center mx-auto mb-6 rotate-12">
                    <span className="material-symbols-outlined text-4xl text-primary -rotate-12">pets</span>
                </div>
                <h1 className="text-3xl font-bold">欢迎回来</h1>
                <p className="text-warm-beige mt-2">登录您的 PawMate 账号</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-bold ml-1 opacity-70">密码</label>
                    <input
                        type="password"
                        value={password}
